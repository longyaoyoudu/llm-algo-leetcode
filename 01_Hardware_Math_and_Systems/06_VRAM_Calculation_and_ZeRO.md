...
> **相关阅读**:  
> 请前往实战篇进行相关代码练习：  
> [`../docs/02_PyTorch_Algorithms/21_Gradient_Checkpointing.md`](../docs/02_PyTorch_Algorithms/21_Gradient_Checkpointing.md)  
> [`../docs/02_PyTorch_Algorithms/23_ZeRO_Optimizer_Sim.md`](../docs/02_PyTorch_Algorithms/23_ZeRO_Optimizer_Sim.md)  
